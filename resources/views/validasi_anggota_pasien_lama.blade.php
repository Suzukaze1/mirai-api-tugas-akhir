...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h3 class="header-title m-b-30">Detail Anggota Pasien</h3>
                    <a href="/list-anggota-pasien-lama" class="btn btn-small btn-primary">Kembali</a>
                    <br><br>
                    @foreach ($pasien as $p)
                    @foreach ($agama as $a)
                    ...
                    <form action="/list-anggota-pasien-lama/validasi/verifikasi" method="post" class="form-horizontal" role="form">
                        @csrf
