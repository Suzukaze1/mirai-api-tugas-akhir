        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <a href="/list-anggota-pasien-baru" class="btn btn-small btn-primary">Kembali</a>
                    <br><br>
                    @foreach ($pasien as $p)
                    @foreach ($agama as $a)
                    ...
                    <form action="/list-anggota-pasien-baru/validasi/verifikasi" method="post" class="form-horizontal" role="form">
                        @csrf
