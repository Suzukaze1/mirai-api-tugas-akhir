...
class PasienSementaraController extends Controller
{
    public function pendaftaranPasienBaruKeTabelSementara(Request $request)
    {
        ...
        try {
            ...
            if($request->daftar_penanggung == 0){
                ...
                $penanggung_umum->nama_penanggung = "1";
                $penanggung_umum->nomor_kartu_penanggung = null;
    ...
    public function pendaftaranUlangPasienBaru(Request $request)
    {
        ...
        // pasien
        $pasien = PasienSementara::find($akun->id_pasien_temp);
        $pasien->no_identitas = $nomor_identitas;
        $pasien->jenis_identitas_kode = $jenis_identitas;
        $pasien->nama = $nama_lengkap;
        $pasien->tempat_lahir = $tempat_lahir;
        ...
        $foto_swa_pasien_tb = Foto::base_64_foto($path_swa, $swafoto, $nama_lengkap);
        $foto_kartu_identitas_tb = Foto::base_64_foto($path_kartu_identitas, $foto_identitas, $nama_lengkap);
        $foto_pasien->id_pasien_temp = $akun->id_pasien_temp;
        $foto_pasien->foto_swa_pasien = $foto_swa_pasien_tb;
        $foto_pasien->foto_kartu_identitas_pasien = $foto_kartu_identitas_tb;
        $foto_pasien->save();
        ...
        if($request->daftar_penanggung == 0){
            ...
            $penanggung->nama_penanggung = "1";
            $penanggung->nomor_kartu_penanggung = null;
            $penanggung->id_pasien_temp = $akun->id_pasien_temp;
            $penanggung->save();
        }else{
            $penanggung_umum = new Penanggung();
            $penanggung_umum->nama_penanggung = "1";
            $penanggung_umum->nomor_kartu_penanggung = null;
            $penanggung_umum->id_pasien_temp = $akun->id_pasien_temp;
            $penanggung_umum->save();
        ...
        $response = [];
            ...
            return ResponseFormatter::success_ok("Berhasil Mendaftar Ulang Pasien Baru", $response);
    }

    public function pendaftaranUlangPasienLama(Request $request)
    {
        // get value text
        $tgl_lahir = $request->tanggal_lahir;
        $jenis_identitas = $request->jenis_identitas;
        ...
        try{
            // cek ke db pasien
            $pasien = Pasien::where('kode', sprintf("%08s", strval($user->kode)))->first();
            ...
            //ubah data detail akun
            $detail_akun = DetailAkun::where('id_pasien', $user->kode)->first();
            $ubah_detail_akun = DetailAkun::find($detail_akun->id);
            $ubah_detail_akun->is_lama = "1";
